...
const yogaPoses = [
  ...
  const listContainer = document.querySelector("#yoga-list");
  ...
  function setupEventListeners() {
    ...
    listContainer.addEventListener("click", (e) => {
      if (e.target.tagName === "ION-CHIP") {
        currentDifficulty = e.target.textContent.trim();
  ...
  function updateList() {
    ...
    const filteredPoses = yogaPoses.filter((pose) => {
      const matchesSearch =
        ...
        pose.benefits.toLowerCase().includes(currentSearch);
        ...
        <ion-card>
          <div class="item-content">
            <div>
              ...
              <div class="item-precautions">注意事項: ${pose.precautions}</div>
